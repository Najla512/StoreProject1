...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.showComplete = function (id, status) {
        return __awaiter(this, void 0, void 0, function () {
            var st, sql, conn, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        st = 'complete';
    ...
    OrderStore.prototype.addOrder = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add product ".concat(o.product_id, " to order ").concat(o.user_id, ": ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
