...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                f = jsonwebtoken_1.default.sign({ users: users }, process.env.TOKEN_SECRET);
                res.json(f);
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newuser = _a.sent();
                token = jsonwebtoken_1.default.sign({ u: newuser }, process.env.TOKEN_SECRET);
                res.json(token);
                return [3 /*break*/, 3];
            case 2:
                err_3 = _a.sent();
